...
include(":instrumentation:alibaba-dubbo-2.6:javaagent")
include(":instrumentation:alibaba-dubbo-2.6:library-autoconfigure")
...
include(":instrumentation:apache-pulsar:apache-pulsar-2.8:javaagent")
include(":instrumentation:apache-pulsar:apache-pulsar-2.8:javaagent-unit-tests")
...
include(":instrumentation:taobao-hsf:library-autoconfigure")
...
include("instrumentation:xxl-job:xxl-job-2.3:javaagent")
