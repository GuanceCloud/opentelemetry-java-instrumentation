...
val profilingTestLauncher = javaToolchains.launcherFor { languageVersion.set(JavaLanguageVersion.of(17)) }
  ...
  test {
    ...
    filter {
      excludeTestsMatching(
        "io.opentelemetry.javaagent.instrumentation.profiling.ProfilingDatakitExportTest")
    }
