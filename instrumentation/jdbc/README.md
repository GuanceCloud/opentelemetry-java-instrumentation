...
| `otel.instrumentation.jdbc.experimental.capture-query-parameters` | Boolean | `false` | Enable the capture of query parameters as span attributes. Enabling this option disables query sanitization. <p>WARNING: captured query parameters may contain sensitive information such as passwords, personally identifiable information or protected health info.                                                                        |
| `otel.jdbc.sql.obfuscation`                                       | Boolean | `false` | Compatibility alias for `otel.instrumentation.jdbc.experimental.capture-query-parameters`. If either property is `true`, query parameters are captured as span attributes and query sanitization is disabled. <p>WARNING: captured query parameters may contain sensitive information such as passwords, personally identifiable information or protected health info. |
